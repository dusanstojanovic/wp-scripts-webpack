...
<div class="wp-block-columns alignfull c-grid  c-grid--1-1"><!-- wp:column {"className":" u-mrg\u002d\u002dreset  c-txt\u002d\u002dbody-lg  js-stagger-appear"} -->
<div class="wp-block-column  u-mrg--reset c-txt--body-lg js-stagger-appear"><!-- wp:image {"id":4201,"sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large"><img src="<?php echo esc_url(home_url('/')); ?>/wp-content/uploads/2024/05/Bilder-fuer-Landingpage-24-1.svg" alt="" class="wp-image-4201"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
